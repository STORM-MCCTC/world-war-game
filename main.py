countries = [{"name": "Afghanistan", "power": 10, "economy": 5, "stability": 4},
...
country_name = input("Name Your Country: ").strip()
country_power = 5
country_economy = 5
country_stability = 100
...
while True:
    ...
    if country_power <= 0 or country_economy <= 0 or country_stability <= 0:
        print("")
        print("---------------------")
        print(f"\nStats for {country_name}:")
        print(f"Name: {country_name}")
        ...
        print("---------------------")
        print("")
        print(f"{country_name} has collapsed. Game over.")
        print("")
        break
    ...
    if user_input == "1":
        ...
        if attack.isdigit() and 1 <= int(attack) <= len(countries):
            ...
            if (attacked_country['power'] <= 0 or 
                attacked_country['economy'] <= 0 or 
                attacked_country['stability'] <= 0):
                print(f"\n{attacked_country['name']} has collapsed and is removed from the game.")
                countries.pop(target_index)
        else:
            print("\nInvalid input. Please enter a valid country number.")
        ...
        country_economy -= 5
        country_stability += 5
        print(f"\nYour country Stabitily increased to {country_stability}")
        print(f"\nYour country Economy decreased to {country_economy}")
